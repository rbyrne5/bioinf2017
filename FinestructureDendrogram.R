...
##################################################################
## Modified for use in Finestructure R Library
## By: Daniel Lawson (dan.lawson@bristol.ac.uk)
## For more details see www.paintmychromosomes.com ("R Library" page)
## Date: 14/02/2012
## Notes:
## These are hacks to do things that may already be possible in the
## dendrogram package.  They should either be properly merged in 
## or replaced by th "proper usage".  Use this version at your own risk!
